...
def calculate_residuals(params, local_coords, geo_coords):
...
def transform_dataframe(
    df: pd.DataFrame, params: list[float], replace: bool = True
) -> pd.DataFrame:
    ...
    transformed_coords = apply_affine_transform(xy_coords, params)
